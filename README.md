...
[![PyPI version](https://badge.fury.io/py/pro-sql-escape.svg)](https://pypi.org/project/pro-sql-escape/)
...
```bash
pip install pro-sql-escape
```

## Quick Start

```python
from pro_sql_escape import escape

# Basic usage
result = escape("your input here")
print(result)
```
...
from pro_sql_escape import batch
